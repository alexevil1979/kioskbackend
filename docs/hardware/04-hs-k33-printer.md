...
- Кодировка: **CP866** + `ESC t 7` (мануал HSPOS). **Не** Epson `ESC t 17` — у HSPOS это греческая таблица.
- CP1251: `windows_encoding: cp1251` → `ESC t 6`. Ручной id: `windows_codepage_id: 7`.
