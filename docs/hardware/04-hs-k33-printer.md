...
- Кодировка: **CP866** + `ESC R 7` + `ESC t 17` перед текстом (**без** `ESC @`).
- `windows_escpos_codepage: false` (по умолчанию). Если кириллица всё ещё неверна — попробуйте `windows_encoding: cp1251`.
