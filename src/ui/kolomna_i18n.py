...
_RU = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB через Windows: режим RAW, кодировка CP866 (как на самотесте HS-K33).",
...
_EN = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB via Windows: RAW mode, CP866 encoding (HS-K33 self-test).",
