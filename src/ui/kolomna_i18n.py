...
_RU = {
    ...
    "ADMIN_DESC_HINT": "Текст описания под названием в меню и на экране товара",
...
_EN = {
    ...
    "ADMIN_DESC_HINT": "Product description below the title in the menu and product screen",
