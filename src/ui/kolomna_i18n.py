...
_RU = {
    ...
    "ADMIN_RUNTIME_SECTION": "Подключение",
    "ADMIN_RUNTIME_HINT": "Текущая конфигурация терминала (только просмотр)",
...
_EN = {
    ...
    "ADMIN_RUNTIME_SECTION": "Connection",
    "ADMIN_RUNTIME_HINT": "Current terminal configuration (read-only)",
