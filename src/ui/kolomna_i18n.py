...
_RU = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB: ESC/POS CP866 напрямую на порт (USB001), не через драйвер TEXT.",
...
_EN = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB: ESC/POS CP866 direct to port (USB001), bypass TEXT driver.",
