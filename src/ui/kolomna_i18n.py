...
_RU = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB: spooler RAW (POS80L) или direct USB001. Тест печатает T1–T3.",
...
_EN = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB: spooler RAW (POS80L) or direct USB001. Test prints T1–T3.",
