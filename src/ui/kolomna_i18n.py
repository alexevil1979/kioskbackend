...
_RU = {
    ...
    "ADMIN_PRINTER_HINT": "Ethernet RAW TCP, порт 9100. Проверка связи без оплаты.",
...
_EN = {
    ...
    "ADMIN_PRINTER_HINT": "Ethernet RAW TCP, port 9100. Connectivity check without payment.",
