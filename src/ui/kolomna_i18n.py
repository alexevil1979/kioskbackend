...
_RU = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB: драйвер XP-80C, spooler RAW, cp866 (ESC t 7).",
    ...
    "ADMIN_PRINTER_PREVIEW": "Предпросмотр чека",
    "ADMIN_PRINTER_PREVIEW_TITLE": "Предпросмотр чека",
    "ADMIN_PRINTER_PREVIEW_CLOSE": "Закрыть",
    "ADMIN_PRINTER_RECEIPT_SAMPLE": "Чек API (заказ #{order_id})",
    "ADMIN_PRINTER_RECEIPT_FETCHING": "Загрузка чека из API…",
    "ADMIN_PRINTER_RECEIPT_NO_API": "Нужен режим API (не тест) и ключ KIOSK_API_KEY",
...
_EN = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB: XP-80C driver, spooler RAW, cp866 (ESC t 7).",
    ...
    "ADMIN_PRINTER_PREVIEW": "Receipt preview",
    "ADMIN_PRINTER_PREVIEW_TITLE": "Receipt preview",
    "ADMIN_PRINTER_PREVIEW_CLOSE": "Close",
    "ADMIN_PRINTER_RECEIPT_SAMPLE": "API receipt (order #{order_id})",
    "ADMIN_PRINTER_RECEIPT_FETCHING": "Fetching receipt from API…",
    "ADMIN_PRINTER_RECEIPT_NO_API": "API mode required (not test) and KIOSK_API_KEY",
