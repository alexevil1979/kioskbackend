...
_RU = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB: RAW, только текст CP866 без ESC-команд (как на самотесте HS-K33).",
...
_EN = {
    ...
    "ADMIN_PRINTER_HINT_USB": "USB: RAW, plain CP866 text only (HS-K33 self-test).",
